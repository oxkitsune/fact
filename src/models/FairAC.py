...
class FairAC2(nn.Module):
    def __init__(self, feature_dim, transformed_feature_dim, emb_dim, args):
        ...
        self.fcdecoder = torch.nn.Linear(
            transformed_feature_dim, transformed_feature_dim * 2
        )
        ...
        self.optimizer_AE = torch.optim.Adam(
            AE_params, lr=args.lr, weight_decay=args.weight_decay
        )
        self.optimizer_AConly = torch.optim.Adam(
